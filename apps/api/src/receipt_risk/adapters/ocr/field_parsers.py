...
_MONTH_WORDS: frozenset[str] = frozenset(
    {
        ...
        "junio", "jun", "julio", "jul", "agosto", "ago", "septiembre", "setiembre",
        "sep", "sept", "set", "octubre", "oct", "noviembre", "nov", "diciembre", "dic",
        "january", "jan", "february", "march", "april", "june", "july", "august",
